      ...
      <div className="flex-1 overflow-y-auto relative">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-24 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 z-10">
          {Array.from({ length: Math.ceil(PRACTICE_DURATION / 5) + 1 }, (_, i) => {
            ...
            const nextInterval = (i + 1) * 5;
            const intervalHeight = Math.min(nextInterval, PRACTICE_DURATION) - minutes;
            ...
            return (
              <div
                ...
                style={{ 
                  ...
                  height: `${intervalHeight * PIXELS_PER_MINUTE}px`
                }}
              >
                <div className="h-full flex items-start justify-end pr-2">
                  {isMajor && (
                    <>
                      ...
                      <div className="w-3 h-full border-r-2 border-gray-700 dark:border-gray-300" />
                    </>
                  )}
                  {isMedium && !isMajor && (
                    <div className="w-2 h-full border-r border-gray-400 dark:border-gray-500" />
                  )}
                  {!isMajor && !isMedium && (
                    <div className="w-1.5 h-full border-r border-gray-300 dark:border-gray-600" />
                  )}
                </div>
              </div>
            );
